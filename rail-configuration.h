...
// Top level macros
#define RAIL_DEVICE_NAME "rangetest"
...
// Use this macro to check if Range Test Application plugin is included
#define RAIL_PLUGIN_RANGETEST_BASE
// User options for plugin Range Test Application
